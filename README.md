# Gadget Hack Central E-commerce Sales Performance Dashboard Using Tableau Public
...
### Profit Overview:
Determine the total amount of profit generated in the last years.
### Sales Person Performance:
Identify the profits made by each sales person.
### Category Insights:
...
Highlight the profit generated by age group.

## Data Sources
The data for this project was provided by the Gadget Hack Central company. 
...
#### Product Focus:
Optimize inventory and promotions by focusing on the most ordered and profit-generating product categories.
...
# Conclusion
The Gadget Hack Central performance dashboard provides valuable insights, but further data exploration and analysis are recommended for a more comprehensive understanding. 
